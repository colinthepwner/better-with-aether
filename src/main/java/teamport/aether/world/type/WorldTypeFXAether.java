...
public class WorldTypeFXAether extends WorldTypeFX {
    ...
    @Override
    public org.joml.Vector3fc getFogColor(World world, double x, double y, double z, float celestialAngle, float partialTick) {
        ...
        g *= f2 * 0.94F + 0.06F;
        b *= f2 * 0.91F + 0.09F;
        return new org.joml.Vector3f((float)r, (float)g, (float)b);
    }
}
