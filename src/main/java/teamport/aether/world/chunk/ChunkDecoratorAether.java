...
public class ChunkDecoratorAether implements ChunkDecorator {
    ...
    private final FractalNoise2D<SimplexNoise> cloudNoise;
    ...
    public ChunkDecoratorAether(World world) {
        ...
        this.flowerDensityNoise = new FractalNoise3D<>(ImprovedPerlinNoise.genOctaves(world.getRandomSeed(), 4, 44));
    ...
    public void decorate(Chunk chunk) {
        ...
        net.minecraft.core.block.BlockLogicFallingBlock.fallInstantly = true;
        ...
        net.minecraft.core.block.BlockLogicFallingBlock.fallInstantly = false;
        this.world.scheduledUpdatesAreImmediate = false;
    }

    private static final double[] CLOUD_NOISE_BUFFER = new double[16 * 16];
    private static final double[] CLOUD_NOISE_2_BUFFER = new double[16 * 16];
    ...
    public void decorateWithFlatClouds(Chunk chunk) {
        ...
        this.cloudNoise.addRegion(
            CLOUD_NOISE_BUFFER,
            chunk.pos.x * 16.0, chunk.pos.z * 16.0,
            16, 16,
            scale * 0.627,
            scale * 2,
            0
        ...
        this.cloudNoise2.getRegion(
            ...
            chunk.pos.x * 16.0, chunk.pos.z * 16.0 - 32.0,
            0.0,
            16, 16, 1,
            scale * 0.627,
            scale * 0.627,
        ...
        this.cloudNoise.addRegion(
            ...
            chunk.pos.x * 16.0 + 32.0, chunk.pos.z * 16.0 + 32.0,
            16, 16,
            scale * 0.627,
            scale * 2,
            0
        ...
        this.cloudNoise2.getRegion(
            ...
            chunk.pos.x * 16.0 + 48.0, chunk.pos.z * 16.0 + 32.0,
            0.0,
            16, 16, 1,
            scale * 0.627,
            scale * 0.627,
        ...
        for (int x = 0; x < 16; ++x) {
            for (int z = 0; z < 16; ++z) {
                int cloudDensity = (int) Math.min(
                    Math.abs(CLOUD_NOISE_2_BUFFER[z + x * 16] + CLOUD_NOISE_BUFFER[z + x * 16]) * 6 - 32, 2
                );
                ...
                int cloudDensity2 = (int) Math.min(
                    Math.abs(CLOUD_NOISE_TOP_2_BUFFER[z + x * 16] + CLOUD_NOISE_TOP_BUFFER[z + x * 16]) * 6 - 40, 1
                );
        ...
        for (int x = 0; x < 16; ++x) {
            for (int z = 0; z < 16; ++z) {
                double noise = MathHelper.clamp(
                    Math.abs(FLOWER_DENSITY_NOISE_BUFFER[z + x * 8]) / 16D,
                    0, 1
                );
                ...
                double influence = MathHelper.clamp(
                    Worley.sampleAt(
                        chunk.pos.x * 16 + x, chunk.pos.z * 16 + z,
                        16,
    ...
    public void decorateWithLakesAndTrees(Random rand, int minY, int maxY, int x, int z) {
        ...
        if (rand.nextInt(8) == 0) {
            ...
            (new WorldFeatureLake(Blocks.FLUID_WATER_STILL.id())).place(this.world, rand, new net.minecraft.core.world.pos.TilePos(x, y, z));
        }
        ...
        for (generateChance = 0; generateChance < 50; ++generateChance) {
            ...
            WATERFALL.place(this.world, rand, new net.minecraft.core.world.pos.TilePos(x, y, z));
        }
    }
    ...
    public void decorateWithOres(Random rand, int minY, int maxY, int worldX, int worldZ) {
        ...
        for (generateChance = 0; generateChance < 10 * oreHeightModifier; ++generateChance) {
            ...
            ORE_DIRT.place(this.world, rand, new net.minecraft.core.world.pos.TilePos(x, y, z));
        }
        ...
        for (generateChance = 0; generateChance < 10 * oreHeightModifier; ++generateChance) {
            ...
            x = worldX + rand.nextInt(16);
            z = worldZ + rand.nextInt(16);
            ORE_ICESTONE.place(this.world, rand, new net.minecraft.core.world.pos.TilePos(x, y, z));
        }
        ...
        for (generateChance = 0; generateChance < 20.0F * oreHeightModifier; ++generateChance) {
            ...
            x = worldX + rand.nextInt(16);
            z = worldZ + rand.nextInt(16);
            ORE_AMBROSIUM.place(this.world, rand, new net.minecraft.core.world.pos.TilePos(x, y, z));
        }
        ...
        for (generateChance = 0; generateChance < 15.0F * oreHeightModifier; ++generateChance) {
            ...
            x = worldX + rand.nextInt(16);
            z = worldZ + rand.nextInt(16);
            ORE_ZANITE.place(this.world, rand, new net.minecraft.core.world.pos.TilePos(x, y, z));
        }
        ...
        for (generateChance = 0; generateChance < 8.0f * oreHeightModifier; ++generateChance) {
            ...
            x = worldX + rand.nextInt(16);
            z = worldZ + rand.nextInt(16);
            ORE_GRAVITITE.place(this.world, rand, new net.minecraft.core.world.pos.TilePos(x, y, z));
        }
    }
