...
public class DensityGeneratorAetherExtended implements DensityGenerator {
    ...
    public double[] generateDensityMap(Chunk chunk) {
        ...
        double[] mainNoiseArray = mainNoise.getRegion(null, x, y, z, xSize, ySize, zSize, (coordScale / mainNoiseScaleX), (heightScale / mainNoiseScaleY), (coordScale / mainNoiseScaleZ));
        double[] minLimitArray = minLimitNoise.getRegion(null, x, y, z, xSize, ySize, zSize, coordScale * 5, heightScale * 9, coordScale * 5);
        double[] maxLimitArray = maxLimitNoise.getRegion(null, x, y, z, xSize, ySize, zSize, coordScale * 5, heightScale * 9, coordScale * 5);
